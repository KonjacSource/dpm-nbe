...
/* package elabzoo-typecheck-closures-debruijn-0.1.0.0 */
#ifndef VERSION_elabzoo_typecheck_closures_debruijn
#define VERSION_elabzoo_typecheck_closures_debruijn "0.1.0.0"
#endif /* VERSION_elabzoo_typecheck_closures_debruijn */
#ifndef MIN_VERSION_elabzoo_typecheck_closures_debruijn
#define MIN_VERSION_elabzoo_typecheck_closures_debruijn(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_elabzoo_typecheck_closures_debruijn */
...
#define CURRENT_COMPONENT_ID "elabzoo-typecheck-closures-debruijn-0.1.0.0-LpABke0m5xH5RZXDu9YbUU-elabzoo-typecheck-closures-debruijn"
